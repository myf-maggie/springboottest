...
//    @GetMapping("/qiangdan")
    ...
    private String qiang(String b) {
        ...
        RedisAgent jedisCom=new RedisAgent();
        RedisAgent.getJedis();
...
//    }
    ...
    public static void main(String[] args) {
        ResisTest resisTest=new ResisTest();
        resisTest.nKuCuen=0;
        resisTest.shangpingKey= "computer_key";
        resisTest.timeout = 30 * 1000;
        resisTest.qiangdan();
    }
}
